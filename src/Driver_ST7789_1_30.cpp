...
void ST7789_ESP32C3::setRotation(uint8_t m) {
  ...
  switch (_rotation) {
    case 0: writeData(0x00); _width = 240; _height = 240; _xstart = 0; _ystart = 0; break;
    case 1: writeData(0x60); _width = 240; _height = 240; _xstart = 0; _ystart = 0; break;
    case 2: writeData(0xC0); _width = 240; _height = 240; _xstart = 0; _ystart = 80; break;
    case 3: writeData(0xA0); _width = 240; _height = 240; _xstart = 80; _ystart = 0; break;
  }
}
